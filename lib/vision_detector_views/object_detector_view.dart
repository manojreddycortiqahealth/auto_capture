...
class _ObjectDetectorView extends State<ObjectDetectorView> {
  ...
  bool _isImageCaptureInProgress = false;
  ...
  Future<void> processImage(InputImage inputImage) async {
    ...
    print(
      'Time Taken to process the Image: ${stopwatch.elapsed}, ${stopwatch.elapsed.inMilliseconds} Milliseconds',
    );

    print('Objects found: ${objects.length}\n\n');
    final objectLabels = <Label>[];
    for (final object in objects) {
      objectLabels.addAll(object.labels);
      print(
        'Object:  trackingId: ${object.trackingId} - ${object.labels.map((e) => e.text)}\n\n',
      );
    }

    final coinObject = objectLabels.firstWhereOrNull(
      (e) => e.text == 'Coin',
    );
